...
export function useTodo() {
  /** @type {[{name: string, desc: string, tags: typeof tagState, startDate: Date, endDate: Date}[], React.Dispatch<any>]} */
  ...
  /**
   * @param {{name: string, desc: string, tags: typeof tagState, startDate: Date, endDate: Date}} data
   */
  function push(data) {
