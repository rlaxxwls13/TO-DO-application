...
export function useTodo() {
  /** @type {[{name: string, desc: string, tags: typeof tagState, startDate: object, endDate: object}[], React.Dispatch<any>]} */
  ...
  /**
   * @param {{name: string, desc: string, tags: typeof tagState, startDate: object, endDate: object}} data
   */
  function push(data) {
